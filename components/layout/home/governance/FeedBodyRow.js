...
const FeedBodyRow = ({ date, desc, logo, type, classes }) => {
  return (
    ...
    >
      <div className="w-11 sm:w-24 xl:w-28 mx-4 xl:mx-8 hidden xs:flex items-center">
        <time
      ...
      <div className="flex-1 mx-4 xs:mx-0 lg:mx-4 xl:mx-8 flex items-center">
      ...
      <div className="w-20 lg:w-24 xl:w-32 px-0 lg:px-4 xl:px-8 flex items-center prevent-select">
        <Image
      ...
      <div className="w-24 xl:w-28 mx-4 xl:mx-8 items-center hidden lg:flex">
        {type}
      </div>
